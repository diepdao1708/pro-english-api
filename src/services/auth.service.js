...
const register = async (user) => {
  ...
  try {
    ...
    let ggRefreshToken = process.env.GG_MAILER_REFRESH_TOKEN;
    ...
    await sendMail(userRec.email, transMail.subject(userRec.email), transMail.template(username, userRec.emailToken), myAccessToken)
      .then((success) => {
